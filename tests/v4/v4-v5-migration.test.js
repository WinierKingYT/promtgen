...
assert.equal(v5Result.project.schemaRevision, 2);
...
assert.equal(repository.projects.get(v4Project.id).schemaRevision, 2, 'Migration is persisted after validation');
...
assert.equal(LATEST_SCHEMA_REVISION, 2);
