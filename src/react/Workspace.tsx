...
export function Workspace({ project, projects, onProject, onNew, onPersist, providerSettings, onProviderSettings, credentialVault }: WorkspaceProps) {
  ...
  return <div className="pg-studio-shell">
    ...
    React key'i olarak kullanmıyor; çocukları yeniden monte etmez. */}
                <LazyFeatureBoundary label="Bölüm yeniden üretimi" resetKey={project.documentRevision}><SectionRegenerationPanel project={project} onCommit={commit} providerSettings={providerSettings} credentialVault={credentialVault}/></LazyFeatureBoundary></>}
