...
export function legacyMigrateToV3(v2State) {
    ...
    v3.identity = v2State.identity || v3.identity;
    ...
    v3.assumptions = v2State.assumptions || [];
    v3.decisions = v2State.decisions || [];
    v3.risks = v2State.risks || [];
    v3.openQuestions = v2State.openQuestions || [];
    ...
    const phaseMap = {
        ...
        PROFILE_DRAFTED: 'PROJECT_PROFILED',
        DISCOVERY_IN_PROGRESS: 'DISCOVERY_IN_PROGRESS',
        MVP_DEFINED: 'SCOPE_DEFINED',
        REQUIREMENTS_DRAFTED: 'OBJECTIVES_DEFINED',
        TECH_OPTIONS_READY: 'EXECUTION_PLAN_DRAFTED',
        TECH_STACK_SELECTED: 'EXECUTION_PLAN_DRAFTED',
        ARCHITECTURE_DRAFTED: 'DELIVERABLES_DEFINED',
        TASKS_DRAFTED: 'EXECUTION_PLAN_DRAFTED',
        AGENT_PACKAGE_DRAFTED: 'EXECUTION_PLAN_DRAFTED',
