...
export function proposeResearchAgenda(project) {
    ...
    return { baseRevision: project.canonicalRevision, questions: candidates.slice(0, 5), optional: true };
}
...
export function applyResearchAgenda(project, agenda, { approvedQuestionIds = [] } = {}) {
    if (agenda.baseRevision !== project.canonicalRevision) return { success: false, project, reason: 'Plan revision değişti; araştırma gündemi yeniden hazırlanmalı.' };
