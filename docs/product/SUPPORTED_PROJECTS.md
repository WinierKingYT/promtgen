...
| 3D oyun | unsupported | Alan paketi bulunmuyor. |
| Çok oyunculu oyun | unsupported | Dağıtık oyun mimarisi destek sözleşmesi dışında. |
| Kritik sağlık sistemi | unsupported | Düzenleyici ve klinik doğrulama sağlanmaz. |
| Kritik finans sistemi | unsupported | Düzenleyici ve finansal güvence sağlanmaz. |
| Büyük dağıtık altyapı | unsupported | Kurumsal kapasite ve operasyon garantisi verilmez. |
